...
(function (Game) {
    var LoginScene = /** @class */ (function (_super) {
        ...
        function LoginScene() {
            ...
            Laya.timer.frameLoop(2, _this, _this.f_update);
            return _this;
        }
        LoginScene.prototype.f_toggleSound = function () {
            Game.GameMgr.sound.toggleOnOff();
        };
        LoginScene.prototype.f_play = function () {
            Game.GameMgr.sound.playCoffee();
            Game.main.enterMainScene();
        };
        LoginScene.prototype.f_about = function () {
            Game.GameMgr.sound.playMushroom();
            Game.main.enterAboutScene();
        };
        LoginScene.prototype.f_update = function () {
